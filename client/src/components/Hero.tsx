...
export default function Hero() {
  return (
    <section className="relative min-h-screen lg:h-[80vh] lg:max-h-[900px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between px-4 sm:px-6 lg:px-8 py-1 sm:py-8 lg:py-16">
        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center">
          ...
          <div className="text-center sm:text-center lg:text-left mb-12 lg:mb-16">
            ...
            <div className="text-left sm:text-center lg:text-left mb-24 sm:mb-4 lg:mb-6 pt-12 sm:pt-0">
