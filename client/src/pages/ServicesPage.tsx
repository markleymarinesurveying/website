...
const detailedServices = [
  ...
  },
  {
    ...
    duration: "2-6+ hours",
    deliverable: "Professional report within 72 hours",
    price: "Starting at $18-25 per foot",
    whatIsIncluded: [
  ...
  },
  {
    ...
    description: "Professional vessel valuation using current market data and condition assessment. Perfect for financing, estate planning, or personal knowledge.",
  ...
  },
  {
    ...
    duration: "2-6+ hours",
    deliverable: "Detailed inspection report within 72 hours",
    price: "Starting at $18-25 per foot",
    whatIsIncluded: [
  ...
  },
  {
    ...
    description: "Expert advice and guidance on vessel purchases, repairs, or technical questions. Markley Marine Surveying will be your boat or yacht consultant. Our expertise will be the best investment you'll ever make.",
      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
            Every survey follows USCG requirements and ABYC standards, providing you with accurate, unbiased assessments
          ...
          <Card className="p-8 bg-primary/5 border-primary/20">
            <CardContent className="space-y-6">
              <h2 className="text-3xl font-bold text-foreground">
                Ready to Schedule Your Marine Survey?
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Contact us today for a detailed quote. We'll discuss your specific needs and 
                provide you with a comprehensive marine survey that meets your requirements.
              </p>
